...
for i in tqdm(range(3000)):
    ...
    if i > 0 and i % 50 == 0:
        ...
        print("itr:({:>5d}) loss_act:{:>6.4f} loss_v:{:>6.4f} aux_act:{:>6.4f} aux_v:{:>6.4f}  loss_ent:{:>6.4f} reward:{:>3.1f}".format(i, np.mean(
